...
//                        title: NSLocalizedString("USE_MANGA_TINT", comment: "")
            ...
            SettingItem(type: "group", title: NSLocalizedString("LIBRARY_UPDATING", comment: ""), items: [
                ...
                SettingItem(
                    type: "switch",
                    key: "Downloads.autoUpscaleEnabled",
                    title: NSLocalizedString("AUTO_UPSCALE_DOWNLOADS", comment: "")
                ),
                SettingItem(
                    type: "stepper",
                    key: "Downloads.autoUpscaleMaxSize",
                    title: NSLocalizedString("AUTO_UPSCALE_MAX_SIZE", comment: ""),
                    minimumValue: 1024 * 1024, // 1MB
                    maximumValue: 50 * 1024 * 1024, // 50MB
                    stepValue: 1024 * 1024 // 1MB steps
                ),
                SettingItem(
                    type: "switch",
                    key: "Downloads.autoUpscaleQualityPreservation",
